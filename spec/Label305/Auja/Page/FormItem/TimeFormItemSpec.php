...
class TimeFormItemSpec extends BaseSpec {

    function it_is_initializable() {
        $this->shouldHaveType('Label305\Auja\Page\FormItem\TimeFormItem');
    }

    function it_has_type_time() {
        $this->getType()->shouldBe('time');
    }
