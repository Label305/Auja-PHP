...
class SpacerMenuItemSpec extends BaseSpec {

    function it_is_initializable() {
        $this->shouldHaveType('Label305\Auja\AujaItem');
        $this->shouldHaveType('Label305\Auja\Menu\MenuItem');
        $this->shouldHaveType('Label305\Auja\Menu\SpacerMenuItem');
    }

    function it_has_spacer_menu_type() {
        $this->getMenuType()->shouldBe('spacer');
    }
    ...
    function it_has_type_properties(){
        ...
        $this->getTypeProperties()->shouldHaveKey('text');
    }
}
