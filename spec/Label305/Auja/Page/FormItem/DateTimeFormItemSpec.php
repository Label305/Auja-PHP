...
class DateTimeFormItemSpec extends BaseSpec {

    function it_is_initializable() {
        $this->shouldHaveType('Label305\Auja\Page\FormItem\DateTimeFormItem');
    }

    function it_has_type_datetime() {
        $this->getType()->shouldBe('datetime');
    }
