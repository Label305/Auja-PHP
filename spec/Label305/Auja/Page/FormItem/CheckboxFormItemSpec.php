...
class CheckboxFormItemSpec extends BaseSpec {

    function it_is_initializable() {
        $this->shouldHaveType('Label305\Auja\Page\FormItem\CheckboxFormItem');
    }

    function it_has_type_checkbox() {
        $this->getType()->shouldBe('checkbox');
    }

    function it_has_a_checked_state(){
        $this->isChecked()->shouldBe(false);
