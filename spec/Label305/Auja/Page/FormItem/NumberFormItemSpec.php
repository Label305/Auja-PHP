...
class NumberFormItemSpec extends BaseSpec {

    function it_is_initializable() {
        $this->shouldHaveType('Label305\Auja\Page\FormItem\NumberFormItem');
    }

    function it_has_type_number() {
        $this->getType()->shouldBe('number');
    }
